  ...
  <div className="flex flex-col items-center justify-center bg-gray-100 rounded-tl-lg rounded-bl-lg p-4">
    ...
    <div className="w-full mb-8">
      <form>
        <div className="flex justify-center mb-4">
          <input
            type="Nombre"
            className="w-full max-w-md py-2 px-4 rounded-lg outline-purple-600 border-[2px] border-purple-400"
        ...
        <div className="flex justify-center mb-4">
          <input
            type="apellidos"
            className="w-full max-w-md py-2 px-4  outline-purple-600 border-[2px] border-purple-400"
       ...
       <div className="w-full max-w-md mx-auto">
          <button
            type="submit"
            className="w-full font-poppins bg-purple-500 text-white py-2 px-4 rounded-lg hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-colors"
          >
            Registrarse
          </button>
    ...
    <div>
      <span className="text-gray-500">
        ...
        <Link
          to="/login"
          className="font-bold text-gray-900 hover:underline hover:text-purple-600 transition-all"
        >
          Iniciar Sesion
        </Link>
      </span>
