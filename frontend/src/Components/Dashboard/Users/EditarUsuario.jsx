    ...
    <div>
      ...
      )}{' '}
      {
       ...
       <div className="flex flex-col md:flex-row md:items-center gap-y-2 mb-8">
         ...
         <div className="flex-1">
           <select className="w-full py-2 px-4 outline-none rounded-lg appearance-none">
       ...
       <hr className="my-8 border-gray-500/30" />
        <div className="flex justify-end">
          <button className="bg-purple-500 text-black py-2 px-4 rounded-lg hover:bg-primary transition-colors">
            Guardar
          </button>
        </div>
     </form>
