  ...
  return (
    <header className="bg-neutral-200 h-[7vh] md:h-[10vh] border-b border-gray-100 p-8 flex items-center justify-end">
      <nav className="flex items-center gap-2">
        ...
        >
          <h1 className="text-gray-400 text-center font-medium">
            Notificaciones (2)
          </h1>
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            <Link
              to="/"
              className="text-gray-400 flex flex-1 items-center gap-4 py-2 px-4 hover:bg-secondary-900 transition-colors rounded-lg"
            >
              ...
              <div className="text-sm flex flex-col">
                ...
                <p className="text-gray-500 text-xs">
                  A Andres Garcia le gusta tu pub...
                </p>
              </div>
            </Link>
          </MenuItem>
        ...
        >
          <MenuItem className="p-0 hover:bg-transparent">
            <Link
              to="/perfil"
              className="rounded-lg transition-colors text-gray-400 hover:bg-secondary-900 flex items-center gap-x-4 py-2 px-6 flex-1"
            >
              <img
                src="https://img.freepik.com/foto-gratis/feliz-optimista-guapo-gerente-ventas-latina-apuntando-lado-mirando-camara_1262-12679.jpg"
                className="w-8 h-8 object-cover rounded-full"
              ...
              <div className="flex flex-col text-sm">
                <span className="text-sm">Andrés García Leyva</span>
                <span className="text-xs text-gray-500">andres@gmail.com</span>
              </div>
            </Link>
          </MenuItem>
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            <Link
              to="/configuracion"
              className="rounded-lg transition-colors text-gray-500 hover:text-white hover:bg-purple-400 flex items-center gap-x-4 py-2 px-6 flex-1"
            >
