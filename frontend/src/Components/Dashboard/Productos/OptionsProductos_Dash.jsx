...
import Filtro_Productos from './Filtro_Productos';
import ExportarProductos_Dash from './ExportarProductos_Dash';
import { Link } from 'react-router-dom';

const OptionsProductos_Dash = () => {
  ...
  return (
    <div className="bg-white shadow-md mb-5 px-4 py-8 flex flex-wrap md:items-start md:justify-start gap-10">
            ...
            <ExportarProductos_Dash className="mr-1" />
          </div>
  );
};

export default OptionsProductos_Dash;
